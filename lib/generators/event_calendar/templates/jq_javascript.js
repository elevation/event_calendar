...
jQuery(document).ready(function($) {
  ...
  $(".ec-event-bg").live("mouseover", function() {
    event_id = $(this).attr("data-event-id");
		class_name = $(this).attr("data-event-class");
    $(".ec-event-"+class_name+"-"+event_id).css("background-color", highlight_color);
  });
  $(".ec-event-bg").live("mouseout", function() {
    event_id = $(this).attr("data-event-id");
		class_name = $(this).attr("data-event-class");
    event_color = $(this).attr("data-color");
    $(".ec-event-"+class_name+"-"+event_id).css("background-color", event_color);
  });
